...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ju1ius_webpack_assets.asset_helper' => 'getJu1iusWebpackAssets_AssetHelperService',
            'ju1ius_webpack_assets.templating.helper' => 'getJu1iusWebpackAssets_Templating_HelperService',
        ...
        $this->privates = array(
            ...
            'ju1ius_webpack_assets.asset_helper' => true,
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KLxwMqeSv0', 0, 'fuP57NB-XPJSKhdzNUqJz6', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'example', 'user' => 'example', 'password' => 'highsec', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    /**
     * Gets the 'ju1ius_webpack_assets.templating.helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ju1ius\WebpackAssetsBundle\Templating\Helper\WebpackAssetsHelper A ju1ius\WebpackAssetsBundle\Templating\Helper\WebpackAssetsHelper instance
     */
    protected function getJu1iusWebpackAssets_Templating_HelperService()
    {
        return $this->services['ju1ius_webpack_assets.templating.helper'] = new \ju1ius\WebpackAssetsBundle\Templating\Helper\WebpackAssetsHelper(${($_ = isset($this->services['ju1ius_webpack_assets.asset_helper']) ? $this->services['ju1ius_webpack_assets.asset_helper'] : $this->getJu1iusWebpackAssets_AssetHelperService()) && false ?: '_'});
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \ju1ius\WebpackAssetsBundle\Twig\WebpackAssetsExtension(${($_ = isset($this->services['ju1ius_webpack_assets.asset_helper']) ? $this->services['ju1ius_webpack_assets.asset_helper'] : $this->getJu1iusWebpackAssets_AssetHelperService()) && false ?: '_'}));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fE1qHIkIjW', 0, 'fuP57NB-XPJSKhdzNUqJz6', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'ju1ius_webpack_assets.asset_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \ju1ius\WebpackAssetsBundle\Helper\AssetHelper A ju1ius\WebpackAssetsBundle\Helper\AssetHelper instance
     */
    protected function getJu1iusWebpackAssets_AssetHelperService()
    {
        return $this->services['ju1ius_webpack_assets.asset_helper'] = new \ju1ius\WebpackAssetsBundle\Helper\AssetHelper('/app/app/Resources/assets/webpack-assets.json');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58eae730328835.12313640')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'Ju1iusWebpackAssetsBundle' => 'ju1ius\\WebpackAssetsBundle\\Ju1iusWebpackAssetsBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'Ju1iusWebpackAssetsBundle' => array(
                    'parent' => NULL,
                    'path' => '/app/vendor/ju1ius/webpack-assets-bundle',
                    'namespace' => 'ju1ius\\WebpackAssetsBundle',
                ),
                'AppBundle' => array(
                    'parent' => NULL,
